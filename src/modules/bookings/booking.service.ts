...
export const bookingService = {
  async make(payload: Record<string, unknown>) {
  ...
  async own() {},
  async update(id: string, payload: any, user: any) {
    ...
    if (bookingData.rows.length === 0) throw new Error("Booking not found");
